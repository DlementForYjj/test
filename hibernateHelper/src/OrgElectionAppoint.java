...
/**
 * OrgElectionAppoint entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "ORG_ELECTION_APPOINT")
public class OrgElectionAppoint implements java.io.Serializable {
	...
	/** default constructor */
	public OrgElectionAppoint() {
	}

	/** minimal constructor */
	public OrgElectionAppoint(String appointId) {
