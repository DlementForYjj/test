...
/**
 * FlowFltInfo entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "FLOW_FLT_INFO")
public class FlowFltInfo implements java.io.Serializable {
	...
	/** minimal constructor */
	public FlowFltInfo(String dataId) {
		this.dataId = dataId;
	}

	/** full constructor */
	public FlowFltInfo(String dataId, String userId, String orgCode,
