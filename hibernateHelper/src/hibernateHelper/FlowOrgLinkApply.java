...
/**
 * FlowOrgLinkApply entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "FLOW_ORG_LINK_APPLY")
public class FlowOrgLinkApply implements java.io.Serializable {
	...
	/** default constructor */
	public FlowOrgLinkApply() {
	}

	/** minimal constructor */
	public FlowOrgLinkApply(String dataId) {
		this.dataId = dataId;
	}

	/** full constructor */
	public FlowOrgLinkApply(String dataId, String userId, String orgCode,
