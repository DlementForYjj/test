...
/**
 * F11 entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "F11")
public class F11 implements java.io.Serializable {
	...
	/** minimal constructor */
	public F11(String f1100) {
		this.f1100 = f1100;
	}

	/** full constructor */
	public F11(String f1100, String a0100, Date f1101, String f1102,
			String f1103, String f1104, Date f1105, String f1106,
			String f1107, String f1108, String f1109, String f1110,
			String f1111, String f1112, String f1113, String f1114,
			String f1115, String f1116, Date f1117, String f1119,
			String f1127, String d0100, String isMain) {
		this.f1100 = f1100;
		this.a0100 = a0100;
		this.f1101 = f1101;
		this.f1102 = f1102;
