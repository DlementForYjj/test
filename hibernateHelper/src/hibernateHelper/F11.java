...
public class F11 implements java.io.Serializable {
	...
	/** full constructor */
	public F11(String f1100, String a0100, Timestamp f1101, String f1102,
			...
			String isMain, String f1108, String f1120, String f1199,
			String d0101, String f1121) {
		this.f1100 = f1100;
		this.a0100 = a0100;
		this.f1101 = f1101;
		this.f1102 = f1102;
	...
	@Column(name = "F1199", length = 1)
	public String getF1199() {
		return this.f1199;
	}

	public void setF1199(String f1199) {
		this.f1199 = f1199;
	}
