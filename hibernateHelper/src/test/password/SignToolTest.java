...
public class SignToolTest {
	public static void main(String[] args) throws UnsupportedEncodingException {
		System.out.println(SignTool.sign("act=logout&userNme=张三&token=XXXXXXXXXXXXXXXX&time=20180530115302", "www.rongji.com"));
		...
		System.out.println(source1.getBytes("UTF-8").length+"个字节");
		System.out.println(SignTool.sign(source1, "www.rongji.com"));
	}
