...
/**
 * DwOrganize entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "DW_ORGANIZE")
public class DwOrganize implements java.io.Serializable {
	...
	/** minimal constructor */
	public DwOrganize(String recordId, String orgCode) {
		this.recordId = recordId;
		this.orgCode = orgCode;
	}

	/** full constructor */
	public DwOrganize(String recordId, Long recordVersion,
			Date recordTime, String recordFrom, String recordCreator,
			String orgCode, String orgName, String orgCategory,
			...
			String isFloating, String orgNumber, String orgPossRelation,
			String unitIndustry, String unitPossRelation, String unitType,
			String isMajorUnit, String unitScale, String unitEconType,
			String legalPersonOrg, String govDeptOrg, String streetCommu,
			String agencyType, String hasVolunteerTeam, String isInstrConn,
			String sendInstr, Integer instrCount, String isRestructUnit,
	...
	@Column(name = "ORG_PROP", length = 128)
