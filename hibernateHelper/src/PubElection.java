...
/**
 * PubElection entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "PUB_ELECTION")
public class PubElection implements java.io.Serializable {
	...
	/** minimal constructor */
	public PubElection(String electionId) {
		this.electionId = electionId;
	}

	/** full constructor */
	public PubElection(String electionId, Integer electionTerm, String orgCode,
